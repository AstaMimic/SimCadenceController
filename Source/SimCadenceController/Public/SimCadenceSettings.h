...
public:
    ...
    UPROPERTY(EditAnywhere, Config, Category="Realtime", meta=(ToolTip="Enable Chaos substepping and set MaxSubstepDeltaTime = 1/FixedHz"))
...
public:
    ...
    virtual FText GetSectionDescription() const override { return FText::FromString(TEXT("Physics-authoritative cadence and training controls.")); }
